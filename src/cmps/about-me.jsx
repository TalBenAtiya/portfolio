...
export const AboutMe = () => {
    ...
    return (
            <section className="about-me flex align-center main-layout">
                <div className="info">
                    <h5 className="small-header">
                        <span className="rectangle"><SmallLine /></span>about me
                    </h5>
                    <h2>Personal Information</h2>
                    <p>Hi, i'm Tal Ben Atiya, a 28 years old Full-Stack Developer living in Israel, Passionate about design and animation.
